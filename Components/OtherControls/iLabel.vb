...
#Region "Properties"
    ...
    ''' <summary>
    ''' Get or Set if the iLabel will Glow when the mouse is over it
    ''' </summary>
    <Category("Appearance")> _
    <Description("Get or Set if the iLabel will Glow when the mouse is over it")> _
    ...
    ''' <summary>
    ''' Get or Set what color the iLabel will Glow when the mouse is over it
    ''' </summary>
    <Category("Appearance")> _
    <Description("Get or Set what color the iLabel will Glow when the mouse is over it")> _
    ...
    ''' <summary>
    ''' Get or Set what Forecolor the iLabel will be when the mouse is over it
    ''' </summary>
    <Category("Appearance")> _
    <Description("Get or Set what Forecolor the iLabel will be when the mouse is over it")> _
    <DefaultValue(GetType(Color), "MediumBlue")> _
                ...
                If _Checked = False Then
                    ...
                    If value Then
                        ...
                        For Each ctrl As Control In Parent.Controls
                            If ctrl.GetType Is GetType(iLabel) Then
                                Dim tgLabel As iLabel = CType(ctrl, iLabel)
        ...
        If (Not context Is Nothing) And (Not provider Is Nothing) Then
            ...
            If Not editorService Is Nothing Then
                ...
                Using dropDownEditor As DropdownColorBlender = New DropdownColorBlender(editorService)
                    ...
                    Dim Instance As New iLabel()
                    If context.Instance.GetType Is GetType(iLabel) Then
                        'For PropertyGrid
                        Instance = CType(context.Instance, iLabel)
                        'Else
                        'For SmartTag To be added later
                        'Instance = CType(CType(context.Instance, iLabelActionList).CurrControl, iLabel)
                    End If
                    ...
                    With dropDownEditor
                        ...
                        .TheSample.FillType = iLabel.eFillType.GradientLinear
